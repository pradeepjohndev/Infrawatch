...
export default function Setting() {
    ...
    return (
        <div className="flex justify-between p-5 bg-white dark:bg-gray-900 text-black dark:text-white/20 rounded shadow min-h-screen" style={{ background: "var(--bg)", color: "var(--text)" }}>
